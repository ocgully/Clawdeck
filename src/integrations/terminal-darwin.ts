...
/**
 * macOS terminal control. Supports iTerm2 and Terminal.app; the strategy is
 * chosen from the captured TERM_PROGRAM.
 *
 ...
 *
 * Best-effort: the pane may have closed, in which case we just log.
 */
...
/**
 * Type text into a session's terminal and submit it. iTerm's `write text` and
