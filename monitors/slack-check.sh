#!/usr/bin/env bash
# Clawdeck monitor: unread Slack messages.
#
...
# only contract Clawdeck cares about is the two directive lines below.
#
# Output protocol:
...
unread="${CLAWDECK_FAKE_UNREAD:-0}"   # demo default so the tile works out of the box
# ---------------------------------------------------------------------------
